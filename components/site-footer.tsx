    ...
    <footer className="border-t bg-background/50 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container py-10">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-2">
              ...
              <nav className="flex flex-col gap-2">
                ...
                <Link href="/#shows" className="text-sm text-muted-foreground hover:text-foreground" scroll={false}>
                  Shows
                </Link>
                <Link href="/#gallery" className="text-sm text-muted-foreground hover:text-foreground" scroll={false}>
                  Gallery
                </Link>
                <Link href="/#about" className="text-sm text-muted-foreground hover:text-foreground" scroll={false}>
                  About
                </Link>
              </nav>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <nav className="flex flex-col gap-2">
                <Link href="/#contact" className="text-sm text-muted-foreground hover:text-foreground" scroll={false}>
                  Enquiries
                </Link>
        ...
        <div className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
          ...
          <p className="mt-2">
            Powered by Stdio<span className="text-red-800">X</span>
          </p>
        </div>
      </div>
    </footer>
